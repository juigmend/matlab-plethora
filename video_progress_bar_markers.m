...
% ..............................................................................
  ...
  video_filename = 'progress_bar_400_300_dark_green_1101f'; % <--- video file name (empty to use markers filename)
...
% ..............................................................................
     ...
     nframes_out = 1101;            % <--- video number of frames (total time), will be overriden if markers file is loaded
         fps_out = 29.97;           % <--- video frame rate
       frame_dim = [400, 300];       % <--- video width and height (pixels)
         pbar_sw = 1;               % <--- make progress bar (1 = yes ; 0 = no and make only markers)
   pbarmk_height = 300;              % <--- progress bar and markers height (pixels)
        mk_width = 3;               % <--- markers width (pixels)
     % pbar_colour = [0.6, 0.3, 0.9]; % <--- progress bar colour (RGB) PINK
     pbar_colour = [0, 0.3, 0]; % <--- progress bar colour (RGB)
...
if isempty(markers_filename) && ~isempty(markers_folder) 
...
for i_vid = 1:n_vid
    ...
    for i_f = 0:nframes_out
        ...
        if ~isempty(markers_filename) % put markers
        rpos = zeros(1,4);
