function d2 = mcerect(d, m1, m2, method)
% Rotates each frame of MoCap data so that a pair of markers remain vertical.
...
for frame = 1:size(d.data,1)
    ...
    d2.data(frame,:) = mcrotate( d2.data(frame,:), 270-180*phi/pi, [0 1 0], [ (x1+x2)/2 , 0 , (z1+z2)/2 ] );
